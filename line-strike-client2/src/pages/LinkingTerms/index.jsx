...
export function LinkingTerms() {
  return (
    ...
    >
      <Dialog flex>
        <Dialog.Header>
          <h3>LINE STRIKE SHOWDOWN! - Terms and Conditions</h3>
        </Dialog.Header>
        <Dialog.Body>
          <p>Welcome to LINE STRIKE SHOWDOWN!!</p>
          <p>
            These terms and conditions outline the rules and regulations for the
            use of this Website, located at https://linestrike.ar.
          </p>
          <p>
            By accessing this website we assume you accept these terms and
            conditions. Do not continue to use LINE STRIKE SHOWDOWN! if you do
            not agree to take all of the terms and conditions stated on this
            page.
          </p>
          <p>
            These terms and conditions are available to read at
            https://linestrike.ar/terms-and-conditions.
          </p>
          <p>
          ...
          <p>
            We employ the use of cookies. By accessing LINE STRIKE SHOWDOWN!,
            you agreed to use cookies in agreement with the
            https://linestrike.ar&apos;s Privacy Policy.
          </p>
          <p>
            We use cookies to let us retrieve the user’s details for each visit
            and to enable the functionality of certain areas to make it easier
          ...
          <p>
            ...
            <HyperLink
              external
              to="https://github.com/holywyvern/line-strike-showdown"
            >
              the Github page
            </HyperLink>
            .
          ...
          <p>
            ...
            We does not filter, edit, publish or review Comments prior to their
            presence on the website. Comments do not reflect the views and
            opinions of https://linestrike.ar, its agents and/or affiliates.
            ...
            https://linestrike.ar shall not be liable for the Comments or for
          ...
          <p>
            https://linestrike.ar reserves the right to monitor all Comments and
          ...
          <p>
            You hereby grant https://linestrike.ar a non-exclusive license to
          ...
          <p>
            ...
            https://linestrike.ar; and (d) the link is in the context of general
          ...
          <p>
            ...
            sending an e-mail to https://linestrike.ar. Please include your
          ...
          <p>
            No use of https://linestrike.ar&apos;s logo or other artwork will be
          ...
          <p>Linking accounts is a service provided by LINE STRIKE SHOWDOWN!</p>
          <p>
            By Linking accounts you are able to perform the following features
            in the website:
          </p>
          <ul>
            <li>Store your used profile names</li>
            <li>Play Ranked matchmaking</li>
            <li>
              Store your{" "}
              <HyperLink
                external
            ...
            <li>Store Decks across devices</li>
            <li>Allow to be found by other players, even when offline.</li>
          </ul>
          <p>
            We will not use your email account for adventising, our only emails
            will only be for system purposes such as recovering your account or
            email verification.
          </p>
          <p>
            Optionally, you may validate your email address. Validation of your
            email address will make the process easier if you need to recover
            your email or password.
          </p>

          <p>Some of these features may not be available at the moment.</p>
        </Dialog.Body>
      </Dialog>
    </div>
  );
